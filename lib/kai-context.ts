...
const pageContexts: Record<string, KaiPageContext> = {
  ...
  "/resources": { title: "Architect Library", purpose: "Available BYNV guides and practical exercises organized by life area, with access shown for each resource.", recommendation: { href: "/daily-focus", label: "Use one resource in Today’s Plan" } },
  ...
  "/orientation": { title: "Your BYNV orientation", purpose: "A short walkthrough of your Blueprint, choosing a priority, building a Cycle with Kai, taking action, checking in, and adjusting as you progress.", recommendation: { href: "/architect-cycle", label: "Build my first 14-day Cycle" } },
  ...
  "/blueprint": { title: "Architect Blueprint", purpose: "Your starting strengths and opportunities from the completed Architect Assessment. You choose what to improve first.", recommendation: { href: "/architect-cycle", label: "Build a first 14-day Cycle" } },
  "/dashboard": { title: "Architect Dashboard", purpose: "Your personal command center: Kai connects your current Cycle, Today’s Plan, unfinished commitments, and saved progress.", recommendation: { href: "/daily-focus", label: "Continue Today’s Plan" } },
  ...
  "/daily-focus": { title: "Today’s Plan", purpose: "Your Daily Operating System: one priority, one to three realistic steps, and a quick check-in. Kai helps you adjust unfinished actions; a note is optional.", recommendation: { href: "/dashboard", label: "See my plan and momentum" } },
  "/goals": { title: "Architect Goals", purpose: "What you want to change or achieve, what success looks like, and which of the seven life areas it affects.", recommendation: { href: "/architect-cycle", label: "Begin an Architect Cycle" } },
  "/challenges": { title: "Architect Challenges", purpose: "Focused, saved practices with transparent progress instead of artificial points.", recommendation: { href: "/daily-focus", label: "Open Today’s Plan" } },
  "/community": { title: "Architect Community", purpose: "Private member Rooms for accountability, challenges, milestones, and conversations about the seven life areas.", recommendation: { href: "/community/rooms/general", label: "Open the General Room" } },
  ...
  "/architect-cycle": { title: "Architect Cycle", purpose: "A short plan built with Kai around the change you choose, realistic steps, an optional constructive commitment rule, and a review of what changed.", recommendation: { href: "/daily-focus", label: "Turn my Cycle into Today’s Plan" } },
  "/momentum": { title: "Momentum", purpose: "See your actions, honest check-ins, recovery decisions, and evidence of change. Choose the next useful move Kai highlights.", recommendation: { href: "/daily-focus", label: "Take my next step" } },
  "/progress": { title: "Momentum", purpose: "Your saved activity and evidence of change, with a useful next move.", recommendation: { href: "/momentum", label: "Open my momentum" } },
