...
const protectedPrefixes = ["/welcome", "/architect-assessment", "/blueprint", "/dashboard", "/daily-focus", "/journal", "/goals", "/challenges", "/architect-cycle", "/progress", "/community", "/feedback", "/settings", "/admin"];
