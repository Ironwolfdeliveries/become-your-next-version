...
const protectedPrefixes = ["/welcome", "/architect-assessment", "/blueprint", "/dashboard", "/daily-focus", "/journal", "/goals", "/challenges", "/architect-cycle", "/progress", "/momentum", "/community", "/feedback", "/settings", "/admin"];
