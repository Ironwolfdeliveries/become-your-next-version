...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="en"><body><JsonLd data={{ "@context": "https://schema.org", "@type": "Organization", name: "Become Your Next Version", alternateName: "BYNV", url, description: "A personal-growth platform for guided reflection and deliberate action." }} /><Navigation /><main id="content">{children}</main><Footer /><AskKai /></body></html> }
