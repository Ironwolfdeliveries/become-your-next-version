...
import "./globals.css";
import { MemberJourneyProvider } from "@/components/member-journey";
...
export default async function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="en"><body><JsonLd data={{ "@context": "https://schema.org", "@type": "Organization", name: "Become Your Next Version", alternateName: "BYNV", url: SITE_URL, email: "becomeyournextversion@gmail.com", logo: `${SITE_URL}/images/kai-approved-face.webp`, description: "A personal-growth platform for guided reflection and deliberate action." }} /><MemberJourneyProvider initial={await getMemberJourney()}><AnalyticsTracker /><Navigation /><main id="content">{children}</main><Footer /><AskKai /></MemberJourneyProvider></body></html> }
