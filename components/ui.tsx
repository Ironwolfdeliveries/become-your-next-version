...
export function CTA({ title = "Your next version starts with a clearer question.", copy = "Take the free Version Snapshot to see where you are now and choose a practical next step." }: { title?: string; copy?: string }) { return <section className="cta container"><div><Eyebrow>Start here</Eyebrow><h2>{title}</h2><p>{copy}</p></div><Button href="/assessment">Take your Version Snapshot</Button></section>; }
